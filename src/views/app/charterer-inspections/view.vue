<template>
  <div class="main-content">
    <breadcumb
      :page="'View Charterer Inspection Details'"
      :folder="'Charterer Inspection'"
    />
    <b-card class="mb-4" title="Charterer Inspection Details">
      <b-row>
        <b-col md="12">
          <b-button
            @click="$router.back()"
              ...
              <b-card-text
                ...
                <b-row>
                  ...
                  <b-col md="4">
                    ...
                    <p class="text-primary text-24 line-height-1 mb-2">
                      {{ charterer_inspection.no_of_issued_deficiencies }}
                    </p>
                  </b-col>
                  <b-col md="4">
                ...
                <b-row>
                  <b-col md="4">
                    ...
                    <p class="text-primary text-18 line-height-1 mb-2">
                      <a
                        :href="`${mediaUrl}${charterer_inspection.reportpath}`"
                        target="_blank"
                        style="color: blue"
                      >
                        Click to see : {{ charterer_inspection.reportpath }}
                      </a>
                    </p>
                  </b-col>
                  <b-col md="4">
                    ...
                    <p class="text-primary text-24 line-height-1 mb-2">
                      {{ charterer_inspection.additional_comments }}
                    </p>
                  </b-col>
                  <b-col md="4">
                    ...
                    <p class="text-primary text-24 line-height-1 mb-2">
                      {{
                        charterer_inspection.is_deficiency_closed == 0
                          ? "NO"
                          : "YES"
                      }}
                    </p>
        ...
        <b-card no-body class="ul-card__border-radius">
          <b-card-header header-tag="header" class="p-1" role="tab">
            <b-button
              ...
              variant="transparent"
              >Charterer Inspection Details</b-button
            >
          </b-card-header>
                      ...
                      >
                        ...
                        <div class="ul-widget-s7__item-text">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="ul-widget-s7__item-text">
                                <p class="text-muted mt-2 mb-0">Remarks</p>
                                <p
                                  class="
                                    text-primary text-24
                                    line-height-1
                                    mb-2
                                  "
                                >
                          ...
                          <div class="row">
                            <div class="col-md-3">
                              <p class="text-muted mt-2 mb-0">Evidence 1</p>
                              <p
                            ...
                            <div class="col-md-3">
                              <p class="text-muted mt-2 mb-0">Evidence 2</p>
                              <p
                                class="text-primary text-18 line-height-1 mb-2"
                              >
                                <a
                            ...
                            <div class="col-md-3">
                              <p class="text-muted mt-2 mb-0">Evidence 3</p>
                              <p
                                class="text-primary text-18 line-height-1 mb-2"
                              >
                                <a
                            ...
                            <div class="col-md-3">
                              <p class="text-muted mt-2 mb-0">Evidence 4</p>
                              <p
                                class="text-primary text-18 line-height-1 mb-2"
                              >
                                <a
...
export default {
  metaInfo: {
    ...
    title: "View Charterer Inspection Details",
  },
  data() {
    return {
      vessel: {
  ...
  methods: {
    ...
    async getData() {
      this.isLoading = true;
      let charterer_inspection = await axios.get(
