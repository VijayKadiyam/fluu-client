        ...
        <b-card>
          <b-form @submit.prevent="submit">
            <b-row>
              ...
              <b-col md="6">
                <b-form-group label="Charterer Name">
                  <b-form-input
                    class="mb-2"
                    label="Charterer Name"
                    placeholder="Enter Charterer Name"
                    v-model.trim="$v.form.charterer_name.$model"
                  >
                  </b-form-input>
                  <b-alert
                    show
                    variant="danger"
                    class="error mt-1"
                    v-if="!$v.form.charterer_name.required"
                    >Field is required</b-alert
                  >
                </b-form-group>
              </b-col>
            ...
            <b-row>
              ...
              <b-col md="4" v-if="form.no_of_issued_deficiencies != 0">
